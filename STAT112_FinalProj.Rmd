...
In this first plot, we are observing the trend between current smokers and their risk for coronary heart disease at an extremely high level. This one plot does not tell us too much, except for the fact that more current smokers are at risk of coronary heart disease, which is to be expected. The purpose of this plot is more to investigate the data.
